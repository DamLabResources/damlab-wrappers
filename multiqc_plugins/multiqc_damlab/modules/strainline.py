...
class StrainlineModule(BaseMultiqcModule):
    def __init__(self):
        # Check debug flag first
        check_debug(config)

        super(StrainlineModule, self).__init__(
            name='Strainline',
            anchor='strainline',
        ...
        for f in self.find_log_files('strainline', filecontents_type='yaml'):
